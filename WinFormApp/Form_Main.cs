...
数独 (Sudoku)
Version 7.1.17000.6230.R14.180924-0000
...
namespace WinFormApp
{
    public partial class Form_Main : Form
    {
        ...
        private static readonly string ApplicationEdition = "7.1.14"; // 程序版本。
        ...
        private static readonly string LabString = "R14"; // 分支名。
        ...
        private void ThemeColorChangedEvents(object sender, EventArgs e)
        {
            ...
            PictureBox_Erase.Image = InterruptImages.Erase;
        ...
        private enum InterruptActions { NULL = -1, StartNew, Continue, Erase, Undo, Redo, Pause, Resume, Restart, ExitGame, CloseApp, COUNT } // 中断动作枚举。
        ...
        private static class InterruptImages // 包含表示中断的图像的静态类。
        {
            ...
            private static Bitmap _Erase = null;
            ...
            public static Bitmap Erase => _Erase; // 擦除。
            ...
            {
                _Erase = new Bitmap(_Size.Width, _Size.Height);

                using (Graphics Grap = Graphics.FromImage(_Erase))
                {
                    Grap.SmoothingMode = SmoothingMode.AntiAlias;

                    Grap.DrawLine(new Pen(color, 2F), new Point(5, 19), new Point(19, 19));
                    Grap.DrawLine(new Pen(color, 2F), new Point(8, 11), new Point(13, 16));
                    Grap.DrawLines(new Pen(color, 2F), new Point[] { new Point(9, 18), new Point(5, 14), new Point(14, 5), new Point(19, 10), new Point(11, 18) });
                }
        ...
        private void EnterGameUI()
        {
            ...
            NewBounds.Size = new Size((Int32)(ElementSize * RW), Me.CaptionBarHeight + Panel_Current.Height + (Int32)(ElementSize * RH));
        ...
        private void Panel_Environment_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            if (RW <= RH)
            {
                if (e.Delta > 0)
                {
                    NewBounds.Location = new Point(NewBounds.X - NewBounds.Width / 20, (Int32)(NewBounds.Y - NewBounds.Width / 20 * RH / RW));
                    NewBounds.Size = new Size(NewBounds.Width + NewBounds.Width / 20 * 2, (Int32)(NewBounds.Height + NewBounds.Width / 20 * RH / RW * 2));
                }
                else if (e.Delta < 0)
                {
                    NewBounds.Location = new Point(NewBounds.X + NewBounds.Width / 20, (Int32)(NewBounds.Y + NewBounds.Width / 20 * RH / RW));
            ...
            else
            {
                if (e.Delta > 0)
                {
                    NewBounds.Location = new Point((Int32)(NewBounds.X - NewBounds.Height / 20 * RW / RH), NewBounds.Y - NewBounds.Height / 20);
                    NewBounds.Size = new Size((Int32)(NewBounds.Width + NewBounds.Height / 20 * RW / RH * 2), NewBounds.Height + NewBounds.Height / 20 * 2);
                }
                else if (e.Delta < 0)
                {
                    NewBounds.Location = new Point((Int32)(NewBounds.X + NewBounds.Height / 20 * RW / RH), NewBounds.Y + NewBounds.Height / 20);
